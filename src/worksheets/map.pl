...
write a program which finds a route between any two places on the map.

For example, from exit 1 to exit 4, your program should be able to produce an instruction represented by the following two list (or something silimar):

[east, south]

[15, 26]

From room '2q25' to exit 1, your program should be able to produce two lists:
